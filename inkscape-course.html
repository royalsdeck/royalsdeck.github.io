...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><img src="images/inkscape.png" style="width:300px;height:150px;"></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>This is a fun course which would help you build your own brand logos and materials and start a career as a graphic designer with a free and popular tool - Inkscape.</p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/m96bAg-d_W8?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
              ...
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/ROkwGbOPhU8?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/B9c4HfCzhU8?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
              ...
              <br><br></center>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/KOj2PSKQ8PM?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Material Design #4</h4>
                <p></p><br>
