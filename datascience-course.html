...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#2E86C1;"><i class="fab fa-python"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to Build your career as a data scientist. Here,you will find the tools and techniques which will help you start building your career in Data Science using Python.</p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/KFRlMR5PTk4?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Web Scrapper</h4>
                <p>Using Beautiful Soup Module.</p><br>
              ...
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/lJ9EEeJq14A?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Data Visualization</h4>
                <p>Using Matplotlib</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/5mR03tesuXQ?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Frontend GUI #1</h4>
                <p>Using Tkinter Library</p><br>
              <br><br></center>
              </div>
            </div><br>
          </div>
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/avr2WXh87f8?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Frontend GUI #2</h4>
                <p>Using Tkinter Library</p><br>
