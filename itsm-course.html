...
<script>
 ...
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:50px;color:#884EA0;line-height:150px;">ITSM</center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Here you will learn to build an industry ready ITSM Platform using Fullstack Php.</p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
             ...
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/ojraunFNLLE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>ITSM #1</h4>
                <p>Learn to build industry application.</p><br>
           ...
           <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/4xlCqFnlUAw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>ITSM #2</h4>
                <p>Learn to build industry application.</p><br>
                ...
                <br><br></center>
                 ...
                 <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/0YyxAAxR2do" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>ITSM #3</h4>
                <p>Learn to build industry application.</p><br>
                <br><br></center>
            ...
            <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/dIIpEWUD56I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>ITSM #4</h4>
                <p>Learn to build industry application.</p><br>
            ...
            <div class="col-md-4"><div class="card">
              <div class="card-body" id="shadow">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/lj74nsQAjts" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
               <h4>ITSM #5</h4>
                <p>Learn to build industry application.</p><br>
