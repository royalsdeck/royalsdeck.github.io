...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:80px;color:#E91E63;"><b><i class="fas fa-link"></i> AJAX</b></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Learn Ajax and Build realtime applications. Ajax is widely used with Javascript to build apps which require no page refresh.Thus, it helps us build dynamic applications. </p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
            ...
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/PwB7NYw-vOY?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Weather App</h4>
                <p>Learn Api Calls with Ajax. Build a realtime weather app.</p><br>
