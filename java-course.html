...
<div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><img src="images/java1.png" style="width:150px;height:150px;"></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>This course will help you build concepts with practical examples in java. This is a beginner to advanced java developer course. Where we will start ground's up.</p></center>
          </div>
          <div class="col-md-1"></div>
        </div>
      </div><br><hr><br>
      <center><h4>Core Java</h4></center><br>
        <div class="row">
                   <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/qiGZuo7p3vc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Java Regex</h4>
                <p>String is valid hex - color code or not ?</p><br>
          ...
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/ghQe5OvmArc?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pattern Problems</h4>
                <p>Pattern 1</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/A6q4i2gWurM?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pattern Problems</h4>
                <p>Pattern 2.</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/e8btEzawxho?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Pattern Problems</h4>
                <p>Pattern 3.</p><br>
              <br><br></center>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/SKKj4YYWwrU?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Java Constructors</h4>
                <p>Implement Constructors with practical example.</p><br>
                ...
                <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/etAyXpyBNC0?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Armstrong Number</h4>
                <p>Learn with an example - Armstrong Number.</p><br>
