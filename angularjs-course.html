...
<script>
 ...
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#C0392B;"><i class="fab fa-angular"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to build your career as a Angularjs developer. Then you have arrived at the right place. Here you will find a series of free resources to help you learn Angularjs from scratch and then go pro by building real time applications. </p></center>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
             ...
             <iframe width="100%" height="200px" src="https://www.youtube.com/embed/YJ1P51AEx3s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>
                <center>
                <h4>Todo Application</h4>
                <p>Start with angular, build a realtime Todo Application.</p><br>
