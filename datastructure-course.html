     ...
     <!--<ul class="navbar-nav ml-auto" style="margin-left:950px;">
        ...
        <ul class="navbar-nav ml-auto">
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" id="nav-link4" style="color:black;text-decoration:none;" href="all_courses.php">Courses</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="nav-link5" style="color:black;text-decoration:none;" href="ourservices.php">Our Services</a>
          </li>
        </ul>
      </div>
    </nav> 
...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><div style="background-color:#5DADE2;"><h1 style="color:white;padding:60px 10px;font-size:40px;">data structures</h1></div></center></div>
          <div class="col-md-7">
            <center>
        ...
        <div class="row">
          <div class="col-md-4"><div class="card">
            ...
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/tnr3sBq4ekY?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
              ...
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/TMEa6E-KBW8?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Inorder,preorder and postorder</h4>
                <p></p><br>
           ...
           <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
           <iframe width="100%" height="200px" src="https://www.youtube.com/embed/o0fF7f2StsU?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Recursion</h4>
                <p></p><br>
