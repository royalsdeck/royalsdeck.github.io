...
<br>
 <div class="container-fluid" style="padding:20px;margin-top:40px;">
      <div class="container" id="shadow" style="padding:30px 10px;">
        <div class="row">
          <div class="col-md-4"><center><h1 style="font-size:150px;color:#A4C639;"><i class="fab fa-android"></i></h1></center></div>
          <div class="col-md-7">
            <center>
            <h5>Course Guidelines</h5><br>
            <p>Want to build your career as an android developer. If so, these tutorials will surely help you to get started with android and java.</p></center>
          </div>
        ...
        <div class="row">
             <div class="col-md-4"><div class="card" id="shadow">
              <div class="card-body">
            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/kj7dR9ucINQ?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>Toasts and Buttons</h4>
                <p>Implement toasts on button click.</p><br>
                <br><br></center>
              </div>
            </div><br>
          </div>
          <div class="col-md-4"><div class="card">
              ...
              <iframe width="100%" height="200px" src="https://www.youtube.com/embed/3fV022KNBhs?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe><br><br>
                <center>
                <h4>ListView</h4>
                <p>Use ListView with Toasts and later with intents.</p><br>
